...
//[assembly: ResolutionGroupName("DCMS.Client.V4")]
[assembly: ExportEffect(typeof(DCMS.BitImageEditor.Droid.TouchTracking.BTouchEffect), nameof(TouchRoutingEffect))]
namespace DCMS.BitImageEditor.Droid.TouchTracking
{
    internal class BTouchEffect : PlatformEffect
    {
        private Android.Views.View view;
        private Element formsElement;
        private TouchRoutingEffect libTouchEffect;
        private bool capture;
        private Func<double, double> fromPixels;
        private readonly int[] twoIntArray = new int[2];
        private static readonly Dictionary<Android.Views.View, BTouchEffect> viewDictionary =
            new Dictionary<Android.Views.View, BTouchEffect>();
        private static readonly Dictionary<int, BTouchEffect> idToEffectDictionary =
            new Dictionary<int, BTouchEffect>();
        ...
        protected override void OnAttached()
        {
            ...
            TouchRoutingEffect touchEffect = (TouchRoutingEffect)Element.Effects.
        ...
        private void CheckForBoundaryHop(int id, Point pointerLocation)
        {
            ...
            BTouchEffect touchEffectHit = null;
        ...
        private void FireEvent(BTouchEffect touchEffect, int id, TouchActionType actionType, Point pointerLocation, bool isInContact)
        {
