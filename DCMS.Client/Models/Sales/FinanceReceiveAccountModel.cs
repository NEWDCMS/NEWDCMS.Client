...
namespace Wesley.Client.Models.Sales
{
    ...
    /// 收款对账单
    /// </summary>
    public class FinanceReceiveAccountBill
    {
        /// <summary>
        /// 业务员
        /// </summary>
        ...
        public IList<FinanceReceiveAccountBillAccounting> FinanceReceiveAccountBillAccountings { get; set; }
    ...
    ///  收款账户（销售单科目映射表）
    /// </summary>
    public class FinanceReceiveAccountBillAccounting : EntityBase
    {
        /// <summary>
        /// 会计科目
        /// </summary>
        ...
        /// 单据Id
        /// </summary>
        public int FinanceReceiveAccountBillId { get; set; }
