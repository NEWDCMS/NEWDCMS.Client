...
namespace Wesley.Client.Models.WareHouses
{
    ...
    /// 用于表示库存商品组合单列表
    /// </summary>
    public partial class CombinationProductBillListModel : Base
    {
    ...
    /// 用于表示库存商品组合单
    /// </summary>
    public class CombinationProductBillModel : EntityBase
    {
    ...
    /// 项目提交或者编辑
    /// </summary>
    public class CombinationProductUpdateModel : Base
    {
