...
namespace Wesley.Client.CustomViews
{
    ...
    public abstract class ALazyView : ContentView, ILazyView, IDisposable, IAnimatableReveal
    {
        ...
        public void Cancel_Clicked(Object Sender, TappedEventArgs args)
        {
            Completed?.Invoke(this, new List<int>());
        }
        ...
        /// <param name="Sender"></param>
        /// <param name="args"></param>
        public void Confirm_Clicked(Object Sender, TappedEventArgs args)
        {
    ...
    public class LazyView<TView> : ALazyView where TView : View, new()
    {
        public override void LoadView()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[LoadView]:{ex.Message} {ex.StackTrace}");
            }
        }
    }
}