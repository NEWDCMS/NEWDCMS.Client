...
namespace Wesley.SlideOverKit.Droid
{
    public class SlideOverKitDroidHandler
    {
        ...
        void ShowBackgroundOverlay (double alpha)
        {
            ...
            _backgroundOverlay.Alpha = (float)value;
    ...
    public class TabSlideOverKitDroidHandler
    {
        TabbedPageRenderer _pageRenderer;
        ISlideOverKitTabbedPageRendererDroid _menuKit;
        IMenuContainerPage _basePage;
        IDragGesture _dragGesture;
        IVisualElementRenderer _popMenuOverlayRenderer;
        global::Android.Widget.LinearLayout _backgroundOverlay;
        ...
        public TabSlideOverKitDroidHandler()
        {
        }


        public void Init(ISlideOverKitTabbedPageRendererDroid menuKit, Context context)
        {
            _menuKit = menuKit;
            _pageRenderer = menuKit as TabbedPageRenderer;
        ...
        void AddMenu()
        {
            ...
            {
                //TabbedPage
                menu.Parent = (TabbedPage)_basePage;
                _popMenuOverlayRenderer = Platform.CreateRendererWithContext(menu, _context);
                Platform.SetRenderer(menu, _popupRenderer);
    ...
    {
        readonly IDragGesture _dragGesture;
        readonly bool _isShow;
        ...
        {
            if (_isShow)
                _dragGesture.NeedShowBackgroundView.Invoke (true, 0.5);
            else
