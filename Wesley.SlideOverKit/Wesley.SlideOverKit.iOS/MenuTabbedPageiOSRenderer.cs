...
using Wesley.SlideOverKit.iOS;
using Xamarin.Forms.Platform.iOS;
using UIKit;
using CoreGraphics;

[assembly: ExportRenderer (typeof(MenuTabbedPage), typeof(MenuTabbedPageiOSRenderer))]
namespace Wesley.SlideOverKit.iOS
{
    public class MenuTabbedPageiOSRenderer : PageRenderer, ISlideOverKitPageRendereriOS
    {
        ...
        public MenuTabbedPageiOSRenderer()
        {
