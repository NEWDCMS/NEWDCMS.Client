...
namespace Wesley.Client.Services
{
    public interface IWareHousesService
    {
        ...
        Task<IList<WareHouseModel>> GetWareHousesAsync(int type, string searchStr = "", int pageIndex = 0, int pageSize = 50, bool force = false, CancellationToken calToken = default);
    }
}