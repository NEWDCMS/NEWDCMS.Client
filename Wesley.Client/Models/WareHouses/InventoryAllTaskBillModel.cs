...
namespace Wesley.Client.Models.WareHouses
{
    ...
    /// 用于表示盘点任务(整仓)列表
    /// </summary>
    public partial class InventoryAllTaskBillListModel : EntityBase
    {
        public IList<InventoryAllTaskBillModel> Items { get; set; } = new List<InventoryAllTaskBillModel>();
    ...
    /// 用于表示盘点任务(整仓)
    /// </summary>
    public class InventoryAllTaskBillModel : EntityBase
    {

        [Reactive] public ObservableCollection<InventoryAllTaskItemModel> Items { get; set; } = new ObservableCollection<InventoryAllTaskItemModel>();
    ...
    /// 盘点任务项目
    /// </summary>
    public class InventoryAllTaskItemModel : ProductBaseModel
    {
    ...
    public class InventoryAllTaskUpdateModel : Base
    {
        ...
        /// 项目
        /// </summary>
        [Reactive] public IList<InventoryAllTaskItemModel> Items { get; set; } = new ObservableCollection<InventoryAllTaskItemModel>();
