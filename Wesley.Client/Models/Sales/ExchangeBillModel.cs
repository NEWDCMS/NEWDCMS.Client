...
namespace Wesley.Client.Models.Sales
{
    ...
    /// 换货单
    /// </summary>
    public class ExchangeBillModel : AbstractBill, IBCollection<ExchangeItemModel>
    {
        ...
        public List<SelectListItem> ExchangeBillDefaultAmounts { get; set; }
        ...
        [Reactive] public ObservableCollection<ExchangeItemModel> Items { get; set; } = new ObservableCollection<ExchangeItemModel>();
        [Reactive] public IList<AccountMaping> ExchangeBillAccountings { get; set; } = new List<AccountMaping>();
    ...
    public class ExchangeBillUpdateModel : BaseBalance
    {
        ...
        public IList<ExchangeItemModel> Items { get; set; } = new ObservableCollection<ExchangeItemModel>();
