            ...
            var node = new TreeViewNode
            {
                ...
                Content = new StackLayout
                {
                    Children =
                    {
                        new ResourceImage
                        {
                            Resource = isItem? "Wesley.Client.Resources.Item.png" :"Wesley.Client.Resources.FolderOpen.png" ,
                            HeightRequest= 16,
                            WidthRequest = 16
                        },
                        label,
        ...
        private class ExpandButtonContent : ContentView
        {
            ...
            protected override void OnBindingContextChanged()
            {
                ...
                if ((isLeafNode) && !node.ShowExpandButtonIfEmpty)
                {
                    ...
                    {
                        Resource = isLeafNode ? "Wesley.Client.Resources.Blank.png" : "Wesley.Client.Resources.FolderOpen.png",
                        HeightRequest = 16,
                        WidthRequest = 16
                    };
                }
                else
                {
                    Content = new ResourceImage
                    {
                        Resource = node.IsExpanded ? "Wesley.Client.Resources.OpenGlyph.png" : "Wesley.Client.Resources.CollpsedGlyph.png",
                        HeightRequest = 16,
                        WidthRequest = 16
                    };
                }
