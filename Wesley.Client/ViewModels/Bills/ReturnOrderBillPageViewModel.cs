...
namespace Wesley.Client.ViewModels
{
    ...
    public class ReturnOrderBillPageViewModel : ViewModelBaseCutom<ReturnReservationBillModel>
    {
            ...
            _popupMenu = new PopupMenu(this, new Dictionary<MenuEnum, Action<SubMenu, ViewModelBase>>
            {
                ...
                { MenuEnum.SHENGHE,async (m,vm)=>{
                    ...
                    ResultData result = null;
                         ...
                         {
                             result = await _returnReservationBillService.AuditingAsync(Bill.Id);
                         }
                ...
                { MenuEnum.HONGCHOU,async (m,vm)=>{
                    ...
                    if (!string.IsNullOrEmpty(remark))
                    {
                        ...
                        {
                            result = await _returnReservationBillService.ReverseAsync(Bill.Id);
                        }
                ...
                { MenuEnum.CHOUGAI,async (m,vm)=>{
                    await _returnReservationBillService.ReverseAsync(Bill.Id);
                } },
                 //结算方式
        ...
        private void ClearBillCache()
        {
            ...
            {
                InitBill();
                Settings.ReturnReservationBill = Bill;
            }
            catch (Exception ex)
            {
        ...
        public void InitPayment()
        {
            try
            {
                ...
                _returnReservationBillService.Rx_GetInitDataAsync(new System.Threading.CancellationToken())
                   .Subscribe((results) =>
                   {
                       try
                       {
                               ...
                               if (!firstOrDefault)
                               {
                                   ...
                                   if (results != null && results?.Code >= 0)
                                   {
                                       ...
                                       if (result != null)
                                       {
                                           ...
                                           .ReturnReservationBillAccountings
        ...
        public async override void OnNavigatedTo(INavigationParameters parameters)
        {
            ...
            try
            {
                ...
                if (parameters.ContainsKey("UpdateProduct"))
                {
                    ...
                    if (p != null)
                    {
                        ...
                        if (Bill.Items?.Any() ?? false)
                        {
                            ...
                            {
                                if (smalProduct != null && smalProduct.GUID.Equals(ip.GUID) && (ip.UnitId == smalProduct.SmallUnitId || ip.SmallUnitId == smalProduct.SmallUnitId))
                                {
                ...
                ReturnReservationBillModel bill = null;
                //加载缓存
                ...
                if (bill == null && ("HomePage".Equals(fromPage) || "AllfunPage".Equals(fromPage) || "VisitStorePage".Equals(fromPage)))
                {
                    ...
                    var cacheBill = Settings.ReturnReservationBill;
                    if (null != cacheBill)
                    {
                        bill = cacheBill;
        ...
        private void InitBill(bool clear = false)
        {
            ...
            if (this.Bill.Id == 0)
            {
                ...
                var setting = Settings.ReturnReservationBill;
                if (setting != null)
                {
